...
// (switch_settings_game_folders()) for *.bin and *.zip files, resolving cover art
// (a same-basename *.png next to the .bin/.zip - see switch/README.md's cover
...
struct LibraryGame {
  ...
  std::string display_name;  // filename without the extension
